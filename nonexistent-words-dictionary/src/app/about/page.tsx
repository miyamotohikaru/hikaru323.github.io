    ...
    <main className="main-content">
      ...
      <div className="dictionary-page">
        <div className="dictionary-page-content">
          <section>
            <h2 className="dict-section-heading">「存在しない言葉辞典」とは</h2>
          ...
          <section>
            <h2 className="dict-section-heading">遊び方</h2>
            <ol className="dict-section-list">
          ...
          <section>
            <h2 className="dict-section-heading">ルール</h2>
          ...
          <section>
            <h2 className="dict-section-heading">お問い合わせ</h2>
            <p className="dict-section-text">
