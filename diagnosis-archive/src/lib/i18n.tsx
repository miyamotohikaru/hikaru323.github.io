...
export const UI = {
  ...
  tagline: { ja: "その障害は、いつから障害になったのか。", en: "When did this disorder become a disorder?" },
  ...
  weeklyEntry: { ja: "今週のエントリ", en: "Entry of the week" },
  readMore: { ja: "詳細を読む →", en: "Read more →" },
  sort: { ja: "SORT", en: "SORT" },
  view: { ja: "VIEW", en: "VIEW" },
  all: { ja: "すべて", en: "All" },
  filter: { ja: "絞り込み", en: "Filter" },
  axes: { ja: "4軸", en: "4 axes" },
