...
export const IDLE: Line[] = [
  ...
  // ── ここから追加(2026-08-08。頻度を上げたぶん、被らないように厚くした) ──
  n("けん、ぬいてくれても いいんだよ"),
  sleepy("ゆめのなかでも さされてた"),
  n("つきの うらがわ、みたことある？"),
  happy("きょうは なんだか いいひ"),
  worry("いま、ちょっと ぐらっとした"),
  n("だれかの けん、あったかい きがする"),
  sleepy("ほしって、まばたきしないんだね"),
  n("ぼくの したに なにが あるんだろう"),
  happy("けんの ならびかた、きれいだね"),
  worry("つぎ、そっちに こないでね"),
  n("こえ、とどいてる？"),
  sleepy("いち、に、さん……あれ、どこまで かぞえたっけ"),
  n("だれも いない よるが いちばん ながい"),
  happy("ここから みる ちきゅう、すきなんだ"),
  worry("あしが しびれてきた かも"),
  n("ぼく、なんで ここに いるんだっけ"),
  sleepy("すこしだけ、めを つぶってる"),
  n("いろんな くにの ひとが きてるみたい"),
  happy("けんが ふえるたび、にぎやかで うれしい"),
  worry("……いまの、なんの おと？"),
  n("うちゅうには かぜが ないんだって"),
  sleepy("ねむいけど、みはってるよ"),
  n("こんど、なまえ おしえてね"),
  happy("きみが きてくれると、ほっとする"),
  worry("そーっと。そーっとね"),
  n("つきの すな、さらさらしてる"),
  sleepy("ぼくの ゆめ、いつも おなじ"),
  n("けんの おと、けっこう すきかも"),
  happy("いっしょに ほしを みようよ"),
  worry("こわいけど、ひとりよりは いいや"),
  n("ここ、じゅうしんが ひくいんだ"),
  sleepy("……zzz"),
  n("ぼく、けっこう がんじょうだよ"),
  happy("なんだか きょうは よく しゃべるね"),
  worry("あしたも ここに いるのかな"),
  n("うでは まだ うごくよ。ほら"),
  sleepy("よふかしは からだに わるいよ"),
  n("だれかが とばした こすくまくんは、いま どこ？"),
  happy("すきな いろ、みつかった？"),
  worry("ぎゅっとしてると こわくない"),
  n("あなが ぜんぶ うまったら どうなるんだろ"),
  sleepy("おきてるってば。ほんとだよ"),
  n("つきに すんでるの、ぼくだけ みたい"),
  happy("けん、にあってるよ"),
];
...
export const HOVER: Line[] = [
  ...
  n("なやんでる かお してる"),
  happy("かんが いいね、きみ"),
  sleepy("どこでも いいよ。ねむいから"),
  worry("ちょっとだけ はなれてくれる？"),
  n("そのあな、なんばんめだろう"),
  happy("そこ、ぼくも いいと おもう"),
  worry("ひぇっ。そこは ちかい"),
];
...
export const SAFE: Line[] = [
  ...
  happy("いきてる。いきてるよ"),
  n("しんぞうが ばくばく してる"),
  happy("きみ、やさしく さしてくれたね"),
  worry("……つぎが こわいんだけど"),
  happy("もう1本 ふえた！"),
  n("いまのは かすっただけ"),
  sleepy("きんちょうしたら ねむくなってきた"),
  happy("ぼくたち、あいしょう いいかも"),
];
