...
export const CREATURES: Creature[] = [
  { id:"kosukuma", name:"こすくまくん", en:"Kosukuma", cat:"special", color:"#F0EDD0", filterType:"kosukuma", fp:{}, desc:"", detail:"", bio:"こすくまくんの世界は、笑っちゃうぐらい彩度バキバキなんです。何もかもが眩しすぎて、現実が抽象化されちゃう。色と色がにじんで、ピンクと青と緑がぐにゃっと混ざる。世界がエモすぎて、感じすぎちゃうから、横になって休む時間が必要なんだよ。クマだから本当は2色しか見えないはずなのに、こすくまくんの脳の中ではこんなに鮮やかに変換されてる。" },
