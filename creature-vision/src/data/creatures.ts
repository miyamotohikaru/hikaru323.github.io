...
export const CREATURES: Creature[] = [
  { id:"kosukuma", name:"こすくまくん", en:"Kosukuma", cat:"special", color:"#F0EDD0", filterType:"kosukuma", fp:{}, desc:"", detail:"", bio:"こすくまくんの世界は、笑っちゃうぐらい色が爆発してて、現実が溶けてる。形は抽象化されて、何が何だかわからなくなる。クマだから本当は2色しか見えないはずなのに、こすくまくんの脳の中ではバキバキに変換されてる。世界が眩しすぎて、横になって休む時間が必要なんだよ。" },
  ...
  { id:"owl", name:"フクロウ", en:"Owl", cat:"sky", color:"#B08050", filterType:"nightvision", fp:{tint:[210,222,242],brightness:2.6}, desc:"", detail:"", bio:"フクロウの目は暗いところで人間の100倍も見えるんです。月のあかりの10分の1でもネズミを見つけられる。目が大きすぎて眼球を動かせないから、首を270度ぐるっと回して補ってるんだよ。" },
  ...
  { id:"octopus", name:"タコ", en:"Octopus", cat:"ocean", color:"#E07070", filterType:"polarized", fp:{strength:0.22}, desc:"", detail:"", bio:"タコは色が1色しか見えないのに、体の色を自由に変えられる不思議な生き物。実は「偏光」っていう光の振動の向きが見えるんです。透明なエビも偏光の違いで丸見え。さらに皮膚にも光を感じるセンサーがあって、体全体が「目」みたいなもの。" },
  ...
  { id:"mshrimp", name:"シャコ", en:"Mantis Shrimp", cat:"ocean", color:"#FF5588", filterType:"tetra", fp:{saturation:1.15,uvTint:[120,90,180],uvStrength:0.25,sharp:0.5}, desc:"", detail:"", bio:"シャコの目には色を感じる細胞が16種類もあるんです（人間は3つだけ）。紫外線も見えるし、「円偏光」っていう特殊な光も見える。でも研究でわかったのは、色を「比べる」んじゃなくて「パッと判別する」方式なんだって。豊かさより確実さを選んだ目なんだね。" },
