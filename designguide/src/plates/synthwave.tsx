...
/* 検分で直したところ。
   初稿は左の稜線が [236,420] で終わり、そこから地平線まで垂直に落ちていた。
   右も [372,424] から垂直に立ち上がっていた。
   結果、太陽の円が左右をまっすぐ切られ、下に細い柱が残って
   「金床（アンヴィル）」の形に見えていた。円が円に見えないと、
   シンセウェイヴの一番の記号が死ぬ。
   稜線を谷まで斜めに下ろし、峰そのものも一段下げて、
   円板の下半分を山が食い込む形にした。垂直の崖はどこにも作らない。 */
const RANGE_L = ridge(-30, 250, [
  [-30, 424], [22, 446], [58, 396], [96, 428], [130, 372], [166, 418], [206, 402], [232, 434],
]);
const RANGE_R = ridge(352, 630, [
  [386, 430], [420, 398], [456, 430], [492, 374], [532, 420], [570, 392], [606, 426], [630, 408],
]);
