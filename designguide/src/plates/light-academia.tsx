 ...
 *
 * ■ 検分で直したこと
 *   明度の幅が机(#ddd1bb)〜紙(#f4efe4)の2段しかなく、185pxでは
 *   地の紙に溶けて空きコマに見えた。淡い様式でも、
 *   **いちばん暗い値をひとつは版面に置かないと縮小に耐えない**。
 *     ・影のマスクを 0.15 → 0.30。斜めの光が版面の骨として立つ。
 *     ・解けた紐を1本渡した。「三通・未投函」を束ねていた紐という
 *       筋が通るうえ、版面でいちばん暗い値をここが受け持つ。
 */
  ...
  return (
    <svg viewBox="0 0 600 800" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="ライト・アカデミア様式の図版">
      ...
      <g clipPath={`url(#${P}-page)`}>
        ...
        {/* ── 束ねてあった紐。解けて机に落ちている ────────────
               三通が「未投函」である理由を、紐ひとつで言う。
               同時に、この版面でいちばん暗い値をここが受け持つ */}
        <g>
          <path d="M -20,722 C 70,706 142,690 206,702 C 258,712 292,738 352,736
                   C 412,734 470,718 528,708 L 554,702 L 548,716 L 526,722
                   C 470,732 412,748 352,750 C 288,754 258,722 204,712
                   C 146,702 78,716 -20,734 Z"
                fill={INK} opacity="0.15" filter={`url(#${P}-soft2)`} transform="translate(2 6)" />
          <path d="M -20,714 C 70,698 142,682 206,694 C 258,704 292,730 352,728
                   C 412,726 470,710 528,700 L 554,694 L 548,708 L 526,714
                   C 470,724 412,740 352,742 C 288,746 258,714 204,704
                   C 146,694 78,708 -20,726 Z"
                fill="#584b3a" />
          {/* 絹の照り。上の縁にだけ一本 */}
          <path d="M -20,716 C 70,700 142,684 206,696 C 258,706 292,732 352,730
                   C 412,728 470,712 528,702"
                fill="none" stroke="#9c8b72" strokeWidth="1.6" opacity="0.5" />
          {/* 結び目の名残。ひと捻り。紐が「解けた」ことはここで言う */}
          <g transform="translate(206 700) rotate(-10)">
            <path d="M -11,-5 L 3,-11 L 7,1 L -7,7 Z" fill="#42382c" />
            <path d="M 1,-9 L 17,-15 L 20,-5 L 5,0 Z" fill="#6b5c48" />
            <path d="M -11,-5 L 3,-11" fill="none" stroke="#9c8b72" strokeWidth="1.2" opacity="0.5" />
          </g>
        </g>
        ...
        <rect width="600" height="800" fill={IRON} opacity="0.3" mask={`url(#${P}-win)`} />
        <g transform="translate(300 400) rotate(-27) skewX(-13) translate(-300 -400)">
          {PANES.map(([x, y], i) => (
